...
class SatelliteEnviroment():
    ...
    def reset(self, H = 1e-4):
        ...
        self.I = (2.0/5.0) * 1 * 0.29 * np.array([[1,0,0],[0,1,0],[0,0,1]])
        self.I_inv = np.linalg.inv(self.I)

        self.w = np.array([0,0,0])
        self.w[0] = random.uniform(-0.5, 0.5)
        self.w[1] = random.uniform(-0.5, 0.5)
        self.w[2] = random.uniform(-0.5, 0.5)
    ...
    def step(self, action):
        ...
        return self.w, self.calculate_reward(), False, trunc
